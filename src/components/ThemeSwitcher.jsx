...
const activeCircleStyle="flex items-center justify-center w-5 h-5 rounded-full";
const ThemeSwitcher = () => {
    ...
    <>
      <div className="flex w-14 h-8 items-center justify-around rounded-full bg-[#2e2f33]">
        <button className={`${activeCircleStyle} ${theme==='light' ? "bg-white": ""}`} onClick={()=>toggleTheme('light')}>
            <svg
        ...
        <button className={`${activeCircleStyle} ${theme==='dark' ? "bg-white": ""}`} onClick={()=> toggleTheme('dark')}>
            <svg
